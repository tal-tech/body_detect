...
namespace facethink {
  ...
  void CUDADetectionOutputLayer<Dtype>::ForwardComputation() {
    ...
    const Dtype* prior_data = this->inputs_[2]->gpu_data();
  ...
  INSTANTIATE_CLASS(CUDADetectionOutputLayer);
